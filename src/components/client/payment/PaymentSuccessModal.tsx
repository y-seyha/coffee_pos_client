...
const PaymentSuccessModal = ({ order, onClose }: SuccessModalProps) => {
  ...
  return (
      ...
      >
        <div
            className="relative bg-[#C1F1A6] w-full max-w-[540px] rounded-[40px] p-8 md:p-12 flex flex-col items-center shadow-2xl"
        ...
        >
          ...
          {/* RECEIPT */}
          <div className="bg-white w-full rounded-[32px] p-6 md:p-8 shadow-sm">
